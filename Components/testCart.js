            ...
            <NavigationEvents
                onDidBlur={() => {
                 ...
                 <ScrollView keyboardShouldPersistTaps='always'>
                     ...
                     { showAddress ? sameAsOffice ? <View style = {{ justifyContent:"center" , alignSelf:"center"}}>
                     <Input
                         label = ""
                     ...
                     </View> : <View style = {{ marginHorizontal:25}}>
                     <Input
                        label = "Line 1"
                   ...
                   <Modal isVisible = { isModalVisible}>
                     <View style = {{ flex:1 , justifyContent:"center" , alignItems:"center"}}>
                      ...
                      <Card style = {{ height:200 , justifyContent:"center" , alignItems:"center" , width:"80%" }}>
                       ...
                       {!isLoading ? 
                        <TouchableOpacity style = {{...Red_Square_button , marginVertical:10}}
